...
class SearchEquipmentView extends GetView<SearchEquipmentController> {
  const SearchEquipmentView({super.key});
...
class _ResultsList extends GetView<SearchEquipmentController> {
  @override
  Widget build(BuildContext context) {
    return Obx(() {
