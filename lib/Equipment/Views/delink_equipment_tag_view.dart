...
class DelinkEquipmentTagView extends GetView<DelinkEquipmentTagController> {
  const DelinkEquipmentTagView({super.key});
                      ...
                      Obx(() {
                        ...
                        return Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 22),
                            ElevatedButton(
                              onPressed: controller.isDelinking.value
                                  ? null
                                  : controller.delinkTag,
                              child: controller.isDelinking.value
                                  ? const SizedBox(
                                      height: 22,
                                      width: 22,
                                      child: CircularProgressIndicator(
                                  ...
                                  : const Text(AppStrings.delinkTag),
                            ),
                          ],
                        );
                      }),
...
class _TagField extends GetView<DelinkEquipmentTagController> {
  @override
  Widget build(BuildContext context) {
    return Row(
      children: [
