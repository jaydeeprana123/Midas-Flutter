...
class SearchAssetLookupView extends GetView<SearchAssetLookupController> {
  const SearchAssetLookupView({super.key});
...
class _ResultsList extends GetView<SearchAssetLookupController> {
  const _ResultsList();
  @override
  Widget build(BuildContext context) {
    return Obx(() {
