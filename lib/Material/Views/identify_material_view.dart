...
class IdentifyMaterialView extends GetView<IdentifyMaterialController> {
  const IdentifyMaterialView({super.key});
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    _InputCard(),
                    Obx(() {
                      if (controller.identifyMaterial.value == null) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(AppStrings.identifyMaterial, style: AppTextStyles.loginTitle()),
        ],
      ),
    );
  }
...
class _InputCard extends GetView<IdentifyMaterialController> {
  @override
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.all(16),
              ...
              Expanded(
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    labelText: AppStrings.scanQrOrPressButtonOrMaterialCode,
...
class _DetailsCard extends GetView<IdentifyMaterialController> {
  const _DetailsCard();

  @override
  Widget build(BuildContext context) {
    return Obx(() {
      final material = controller.identifyMaterial.value;
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            _DetailRow(
              label: AppStrings.materialNameLabel,
              value: material.materialName,
            ),
            _DetailRow(
              label: AppStrings.materialCodeLabel,
              value: material.materialCode,
            ),
            _DetailRow(
              label: AppStrings.tagCodeLabel,
              value: material.tagCode,
            ),
            _DetailRow(
              label: AppStrings.rfid,
              value: material.rfid,
            ),
            _DetailRow(
...
class _DetailRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final displayValue =
        value.trim().isEmpty ? AppStrings.notAvailable : value.trim();
