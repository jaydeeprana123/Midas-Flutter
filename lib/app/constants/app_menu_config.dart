...
class AppMenuConfig {
  ...
  static const items = <AppMenuItem>[
    ...
    AppMenuItem(
      permissionLabel: 'Material Tagging',
    ...
    AppMenuItem(
      permissionLabel: 'Material Delink',
    ...
    AppMenuItem(
      permissionLabel: 'Material Location Assign',
    ...
    AppMenuItem(
      permissionLabel: 'Material Location Change',
      title: AppStrings.changeLocationByMaterial,
      icon: Icons.sync_problem,
      section: AppMenuSection.materials,
